...
namespace PaintApp
{
    public partial class FindContour : Form
    {
        ...
        private void Confirm_click(object sender, EventArgs e)
        {
            ...
            tempCanvas.CopyTo(_mainform.canvas);
            Close();
        }
        ...
        private void findCounterAsync()
        {
            ...
            if(tempCanvas.Channels() != 1)
                Cv2.CvtColor(tempCanvas, tempCanvas, ColorConversionCodes.BGR2GRAY);
            if(tempContour.Channels() != 1)
                Cv2.CvtColor(tempContour, tempContour, ColorConversionCodes.BGR2GRAY);
            ...
            Cv2.CvtColor(tempContour, result, ColorConversionCodes.GRAY2BGR);

            Cv2.DrawContours(result, contours, -1, Scalar.Green, 3);

            tempContour = result.Clone();
            UpdatePictureBox();
        }
        ...
        private void UpdatePictureBox()
        {
            ...
            Preview_box.Image = BitmapConverter.ToBitmap(tempContour);
        }
